...
//! A cylinder is a special type of prim.
//
...
public:
   ...
   Cylinder()
   {
   	   DEBUG( "Cylinder::Cylinder" );
   	   sprintf( ObjectType, "PRIM" );
   	   sprintf( sDeepObjectType, "CYLINDER" );
   	   sprintf( PrimType, "CYLINDER" );
   	   color0.r = 0.2;
   	   color0.g = 0.2;
   	   color0.b = 0.2;
   ...
   //virtual void CopyTo( Cylinder *ptargetcube );
